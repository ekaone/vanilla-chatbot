...
function addToChat(input, finalResult) {
  ...
  userDiv.innerHTML = `<span>${input}</span><img src="https://res.cloudinary.com/ddjsyskef/image/upload/v1626237232/public/weqlgdwc9nmbqpyxcwnn.png" alt="Robot cartoon" height="20px" width="20px">`;
  ...
  botDiv.id = "bot";
  botImg.src =
    "https://res.cloudinary.com/ddjsyskef/image/upload/v1626237233/public/c6m1zyyqxl6x8p9irxtj.jpg";
